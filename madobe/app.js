...
const I18N = {
  en: {
    ...
    faq_a6: "Yes — the daily microseason widget is free. Madobe Pro ($1.99 / month or $17.99 / year) adds Japanese window frames (round, lattice, shōji), scene themes (photoreal 3D, ukiyo-e), the daily seasonal column with food / festivals / kigo, save favorites to a collection, wallpaper export, and removes ads.",
  ...
  jp: {
    ...
    faq_a6: "はい、毎日のミニチュアウィジェットは無料です。Madobe Pro（月額¥300、または年額¥2,800）では、和風の窓枠（丸窓・格子窓・障子窓）、情景テーマ（写実3D・浮世絵テイストなど）、季節のコラム（旬の食べ物・行事・季語）、お気に入りの情景の保存、壁紙エクスポートが解放され、広告も非表示になります。",
    faq_q7: "対応言語と対応機種は？",
